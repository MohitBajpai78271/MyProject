...
class ProfileViewController: UIViewController, UITextFieldDelegate{
    ...
    override func viewDidLoad() {
        ...
        MobileNo.text = UserData.shared.phoneNumber
    ...
    func loadUserData() {
//        guard let user = UserProvider.shared.getUser() else { return }
//             NameOfPerson.text = user["userName"] as? String
//             MobileNo.text = user["phoneNumber"] as? String
//             DateOfBirth.text = user["dateOfBirth"] as? String
//             PoliceStation.text = user["address"] as? String
       }
    ...
    func updateUserFields(with user: User) {
         NameOfPerson.text = user.userName
